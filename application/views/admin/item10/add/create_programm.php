...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header">Event Programm Create
            ...
            <div class="p20">
                ...
                <form action="<?php echo base_url('admin_create_item_ev_p_act/'.$id); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <!--                                    <option value="--><?php //echo $item->i_c7_id; ?><!--">--><?php //echo $item->i_c7_name; ?><!--</option>-->
                    <!--                                --><?php //} ?>
                    <!---->
                    <!--                            </select>-->
                    <!--                        -->
