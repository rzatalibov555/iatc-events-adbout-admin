    ...
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            ...
            <div class="p20">
                ...
                <form action="<?php echo base_url('admin_create_item_ev_act'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 noBlock">
                                <div class="row">
                                    ...
                                    <input type="text" name="group_size" id="group_size" class="form-control">
                                    <!-- form validation start display show -->
                                    <?php if(isset($form_error)){ ?>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 noBlock">
                            ...
                            <select id="cate" class="form-control" name="category">
                                ...
                                <?php foreach ($get_all_item_category as $item){ ?>
                                    <option value="<?php echo $item->i_c10_id; ?>"><?php echo $item->i_c10_name; ?></option>
                                <?php } ?>
