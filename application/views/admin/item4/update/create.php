...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header"><?php echo "<b>".$single_item->ab_title."</b>"." - About Edit"; ?>
            ...
            <div class="p20">
                ...
                <form action="<?php echo base_url('admin_updateItem_abAct/'.$single_item->ab_id); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div id="aze" class="tab-content current">
                        ...
                        <input type="text" name="title_az" id="taze" class="form-control" placeholder="Enter title" value="<?php echo $single_item->ab_title ; ?>">
                        ...
                        <textarea name="descr_az" rows="10" cols="50" id="daze" class="form-control"><?php echo $single_item->ab_description ; ?></textarea>
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div id="eng" class="tab-content">
                        ...
                        <input type="text" name="title_en" id="teng" class="form-control" placeholder="Enter title" value="<?php echo $single_item->ab_title_en ; ?>">
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                        ...
                        <textarea name="descr_en" rows="10" cols="50" id="deng" class="form-control"><?php echo $single_item->ab_description_en ; ?></textarea>
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div id="rus" class="tab-content">
                        ...
                        <input type="text" name="title_ru" id="trus" class="form-control" placeholder="Enter title" value="<?php echo $single_item->ab_title_ru ; ?>">
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                        ...
                        <textarea name="descr_ru" rows="10" cols="50" id="drus" class="form-control"><?php echo $single_item->ab_description_ru ; ?></textarea>
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div id="tur" class="tab-content">
                        ...
                        <input type="text" name="title_tr" id="ttre" class="form-control" placeholder="Enter title" value="<?php echo $single_item->ab_title_tr ; ?>">
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                        ...
                        <textarea name="descr_tr" rows="10" cols="50" id="dtur" class="form-control"><?php echo $single_item->ab_description_tr ; ?></textarea>
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
...
<!--                            <input type="date" name="date" id="date" class="form-control" value="--><?php //echo $single_item->ab_date ; ?><!--">-->
<!--                            -->
<!--                            --><?php //if(isset($form_error)){ ?>
...
<!--                                    <option --><?php //if($single_item->ab_category == $item->i_c4_id){ echo "SELECTED"; } ?><!-- value="--><?php //echo $item->i_c4_id; ?><!--">--><?php //echo $item->i_c4_name; ?><!--</option>-->
<!--                                --><?php //} ?>
<!---->
<!--                            </select>-->
<!--                        -->
