...
<!--                        <p>--><?php //echo date("d-m-Y", strtotime($single_item->ab_date)); ?><!--</p>-->
<!--                    </div>-->
<!---->
...
<!--                        <p>--><?php //echo $single_item->i_c4_name; ?><!--</p>-->
<!--                    </div>-->
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 noBlock">
                    <?php if($single_item->ab_img){ ?>
                        <img width="100%" src="<?php echo base_url('upload/about/'.$single_item->ab_img); ?>">
                    <?php }else{ ?>
