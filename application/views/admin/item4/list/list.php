    ...
    <div class="col-md-12">
        ...
        <div class="main-card mb-3 card">
            <div class="card-header">About List
                <div class="btn-actions-pane-right">
                    <div role="group" class="btn-group-sm btn-group">
                        <a href="<?php echo base_url('admin_create_item_ab'); ?>">
            ...
            <?php if(empty($items)){ ?>
                ...
                <span>Hər hansı bir məlumat tapılmadı. Məlumat daxil etmək üçün <a href="<?php echo base_url('admin_create_item_ab'); ?>" style="color: green">əlavə et</a></span>
            </div>
            <?php }else{ ?>
                        ...
                        <tbody>
                            ...
                            <?php $itemCount = 1; $for_switch=0; foreach ($items as $item){ $for_switch++; ?>
                                <tr>
                                    ...
                                    <td><?php echo $item->ab_title; ?></td>
<!--                                    <td class="text-center">--><?php //echo date("d-m-Y", strtotime($item->ab_date)); ?><!--</td>-->

                                    <td class="text-center">
                                        <?php if($item->ab_img){ ?>
                                            <img width="50" src="<?php echo base_url('upload/about/'.$item->ab_img); ?>">
                                        <?php }else{ ?>
...
<!--                                            <input type="checkbox" class="toggle_Switch" id="switchbox--><?php //echo $for_switch; ?><!--" --><?php //echo ($item->ab_status == 1) ? "checked" : ""; ?><!-- data-toggle="toggle">-->
<!--                                        </label>-->
<!--                                    </td>-->
                                
                                    <td class="text-center">
                                        <a style="text-decoration: none;" href="<?php echo base_url('admin_detail_form_ab/'.$item->ab_id); ?>">
                                            <button type="button" id="PopoverCustomT-1" class="btn btn-outline-primary">Details</button>
                                        </a>

                                        <a style="text-decoration: none;" href="<?php echo base_url('admin_update_form_ab/'.$item->ab_id); ?>">
                                            <button class="btn-wide btn btn-outline-warning">Edit</button>
                                        </a>

                                            <button
                                                    data-url="<?php echo base_url('admin_deleteItem_ab/'.$item->ab_id); ?>"
                                ...
                                <script>
                                    $(document).ready(function() {
                                        ...
                                        $("#switchbox<?php echo $for_switch; ?>").change(function(){
                                            ...
                                            var post_id = <?php echo $item->ab_id; ?>;
                                            var checkbox_val;
                                            if(this.checked) {
                                                checkbox_val = '1';
                                            }else{
                                            ...
                                            $.ajax({
                                                url : "<?php echo base_url('admin_is_active_set_item_ab'); ?>",
                                                type: 'post',
                                                data: dataJson,            
